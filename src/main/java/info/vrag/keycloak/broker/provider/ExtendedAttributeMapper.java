...
import info.vrag.keycloak.broker.provider.StringToken;
...
public class ExtendedAttributeMapper extends AbstractIdentityProviderMapper {
    ...
    protected static final Logger logger = Logger.getLogger(ExtendedAttributeMapper.class);
    ...
    private static final String PROVIDER_ID = "idp-extended-attribute-mapper";
    ...
    static {
        ...
        property1.setHelpText("Path of field in Social provider User Profile JSON data to get value from. You can use dot notation for nesting and square brackets for array index. You can use string to concat with fields. Eg. \"constant_value\" + contact.address[0].country");
    ...
    public String getDisplayCategory() {
        return "Extended Attribute Importer";
    }
    ...
    public String getHelpText() {
        return "Extended import user profile information if it exists in Social provider JSON data into the specified user attribute.";
    }
    ...
    public void preprocessFederatedIdentity(KeycloakSession session, RealmModel realm, IdentityProviderMapperModel mapperModel, BrokeredIdentityContext context) {
        ...
        String value = getRawFieldValue(mapperModel, context);
        if (value != null) {
    ...
    public void updateBrokeredUser(KeycloakSession session, RealmModel realm, UserModel user, IdentityProviderMapperModel mapperModel, BrokeredIdentityContext context) {
        // Method runs on login user if user exists in Keycloak
        String attribute = getAttribute(mapperModel);
        if (attribute == null) {
            return;
        }
    ...
    protected String getJsonValueFromModel (IdentityProviderMapperModel mapperModel) {
    ...
    protected static String getJsonValue(String jsonField, BrokeredIdentityContext context) {
        ...
        if (value == null) {
            ...
            logger.errorf("%s not support list in json value", PROVIDER_ID);
        }
